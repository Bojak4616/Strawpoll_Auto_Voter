...
def worker(proxyDict):
	...
	try:
		#proxies=proxyDict,
		r = requests.get("http://strawpoll.me/6770460", headers=headers)
		cookies = {'__cfduid': r.cookies["__cfduid"]}
			
		vote = []
		vote.append(2)
		r = requests.post("http://strawpoll.me/api/v2/votes", headers=headers, cookies=cookies, proxies=proxyDict, json={"pollId":"6770460", "votes": vote})
...
if __name__ == '__main__':
	...
	for num in range(0,numProxies-1):
		...
		t = threading.Thread(target=worker, args=(proxyDict,))
		t.start()	
